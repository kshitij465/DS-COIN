...
public class MerkleTree {
  ...
  public List<Pair<String,String>> siblingpath(int index){
    TreeNode aa=rootnode;
    ArrayList<Pair<String,String>> ans = new ArrayList<Pair<String,String>>();
    int maxx=numdocs;
    ans.add(0,new Pair<String,String>(aa.val,null));
    while(aa.left!=null){
      if(index>maxx/2){
        aa=aa.right;
        maxx=maxx/2;
      ...
      ans.add(0,new Pair<String,String>(aa.parent.left.val,aa.parent.right.val));
    }
    return ans;
  }
